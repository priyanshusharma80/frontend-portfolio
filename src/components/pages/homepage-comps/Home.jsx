      ...
      <section name="Home" className='relative w-full md:h-screen h-unset'>
        ...
        <div className='max-w-screen-lg mx-auto flex flex-col items-center justify-center h-full px-4 py-16 md:py-0 md:flex-row md:gap-8'>
          ...
          <div className='flex flex-col justify-center items-center h-[85%] md:h-full order-2 md:order-1 md:items-start'>
            ...
            <h1 className='text-4xl md:text-6xl font-bold text-white mb-2 mt-3 md:mt-0 md:mb-4'>Hi, I'm Priyanshu!</h1>
            <h2 className='rounded-md bg-primary-color/20 max-w-max px-6 inline text-xl md:text-3xl lg:text-4xl font-semibold text-white'>Freelance Frontend Developer</h2>
            <p className='text-gray-300 py-4 max-x-md text-justify'>
            Frontend Engineer with over 2 years of experience as a freelancer, helping clients design modern, responsive websites that drive user engagement and generate leads. Proficient in HTML, CSS, JavaScript, React, and SEO strategies, I specialize in creating scalable web solutions tailored to client needs.</p>
